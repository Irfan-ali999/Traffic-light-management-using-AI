...
import collections
import numpy as np
from tracker import *  # Ensure this file exists and contains the EuclideanDistTracker class
import os
...
cap = cv2.VideoCapture('video.mp4')  # Make sure 'video.mp4' is in the correct directory
input_size = 320
...
# Class index for required detection classes
...
def count_vehicle(box_id, img):
    ...
    # Draw circle at the center of the rectangle
    cv2.circle(img, center, 2, (0, 0, 255), -1)

# Function for processing the network's outputs
...
def realTime():
    while True:
        ...
        plt.pause(0.01)  # Pause briefly to simulate real-time video playback

        # Clear the figure for the next frame (optional)
        plt.clf()
